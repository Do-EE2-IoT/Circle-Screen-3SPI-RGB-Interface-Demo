...
#define EXAMPLE_LCD_IO_RGB_DE (GPIO_NUM_0)
#define EXAMPLE_LCD_IO_RGB_PCLK (GPIO_NUM_9)
#define EXAMPLE_LCD_IO_RGB_DATA0 (GPIO_NUM_14)
#define EXAMPLE_LCD_IO_RGB_DATA1 (GPIO_NUM_13)
#define EXAMPLE_LCD_IO_RGB_DATA2 (GPIO_NUM_12)
#define EXAMPLE_LCD_IO_RGB_DATA3 (GPIO_NUM_11)
#define EXAMPLE_LCD_IO_RGB_DATA4 (GPIO_NUM_10)
#define EXAMPLE_LCD_IO_RGB_DATA5 (GPIO_NUM_39)
#define EXAMPLE_LCD_IO_RGB_DATA6 (GPIO_NUM_38)
...
#define EXAMPLE_LCD_IO_RGB_DATA16 (GPIO_NUM_5)
#define EXAMPLE_LCD_IO_RGB_DATA17 (GPIO_NUM_6)
#define EXAMPLE_LCD_IO_SPI_CS (GPIO_NUM_4)
#define EXAMPLE_LCD_IO_SPI_SCL (GPIO_NUM_7)
#define EXAMPLE_LCD_IO_SPI_SDA (GPIO_NUM_15)
#define EXAMPLE_LCD_IO_RST (GPIO_NUM_16) // -1 if not used
